...
class ArticleRepositoryImpl(
    ...
    override fun observeArticles(): Flow<List<Article>> = dao.observeAll().map { list -> list.map { it.toDomain() } }
    ...
    override suspend fun getArticleByUrl(url: String): Article? = dao.getByUrl(url)?.toDomain()
}
